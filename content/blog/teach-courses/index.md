...
{{< cite page="/publications/adipocyte-size-distribution-mathematical-model-of-a-tissue-p" view="citation" >}}

You can also use the default view by omitting the view parameter:

{{< cite page="/publications/rapid-cell-turnover-to-model-adipocyte-size-distribution" >}}
